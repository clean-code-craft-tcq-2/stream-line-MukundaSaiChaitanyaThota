...
class RcevierTest(unittest.TestCase):
    ...
    def test_extractEachParameterReadings(self):
        self.assertTrue(receiver.extractEachParameterReadings([[25,13],[6,15]], "SOC") == [5,6])
    ...
    def test_calculateMovingAverage(self):
        self.assertTrue(receiver.calculateMovingAverage([8,12,4,5,11,19,16,14], 5) == [8.0,9.6,10.4,12.4])
    ...
    def test_formulateReadings(self):
        self.assertTrue(receiver.formulateReadings(['5,10\n','6,15\n']) == [[5,10],[6,15]])
